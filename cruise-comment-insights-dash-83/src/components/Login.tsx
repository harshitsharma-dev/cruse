      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="text-center">
          ...
          <CardContent>            {/* Quick Login Options - Updated for actual authentication */}
            <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">              <div className="text-sm font-semibold text-blue-900 mb-4 text-center">Production Accounts Available (Click to Fill)</div>
              <div className="grid grid-cols-1 gap-3 text-sm">
                ...
                <div className="flex justify-between items-center p-3 bg-white rounded-lg border border-blue-200 hover:shadow-md transition-all cursor-pointer hover:bg-blue-50" onClick={() => handleQuickLogin('testAdmin', 'test')}>
                  <span className="font-medium"><strong>testAdmin</strong> / <strong>test</strong></span>
                  <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">Admin</span>
                </div>
                ...
                <div className="flex justify-between items-center p-3 bg-white rounded-lg border border-green-200 hover:shadow-md transition-all cursor-pointer hover:bg-green-50" onClick={() => handleQuickLogin('test1', 'test')}>
                  <span className="font-medium"><strong>test1</strong> / <strong>test</strong></span>
                  <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold">User</span>
                </div>
              </div>
              <div className="mt-3 text-xs text-blue-600 text-center">
                <p>💡 Click any account card above to auto-fill the login form</p>
              </div>
